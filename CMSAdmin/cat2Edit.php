	...
	<div class="col_main">
      <div class="content">
		...
		<!--	<tr>
				...
				<a href="../<? echo $folder.$row["img_en"]; ?>" target="_blank" class="deleteLink"><img src="../<?php echo $folder.$row["img_en"]; ?>" width="120px"></a> 
			...
			<tr>
				...
				<a href="../<? echo $folder.$row["img_tc"]; ?>" target="_blank" class="deleteLink"><img src="../<?php echo $folder.$row["img_tc"]; ?>" width="120px"></a> 
