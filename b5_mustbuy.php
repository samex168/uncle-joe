...
<div id="content" class="ui_inside">
  	<div>
    	<h1><img src="images/banner_mustbuy.jpg" width="1200" height="220" alt=""/></h1>
        <p id="path">全城優惠</p>
        <ul id="porductlist" class="ui_nolst ui_nomp">
            ...
            <li>
                ...
                <p><a href="javascript:void(0);"><span class="ui_info1">衍生至尊感冒止咳顆粒沖劑 (8包裝)</span></a><br><span class="ui_price2">$135/盒</span><br><a href="javascript:void(0);" class="ui_btn_addcart">加入購物車</a></p>
            </li>
            <li>
                <a href="javascript:void(0);" class="productimg"><img src="images/product/temp_001.jpg" alt="" /></a>
                <p><a href="javascript:void(0);"><span class="ui_info1">衍生至尊感冒止咳顆粒沖劑 (8包裝)</span></a><br><span class="ui_price2">$135/盒</span><br><a href="javascript:void(0);" class="ui_btn_addcart">加入購物車</a></p>
        ...
        <ul id="paging" class="ui_nolst ui_nomp">
            ...
            <li class="ui_separate"><span>到第</span><input type="text"><span>頁</span></li>
            <li><a href="javascript:void(0);">確定</a></li>
        </ul>
    </div>
</div>
